...
- 可供人工定 IP 讨论的初步短名单为《镜花缘》《牡丹亭还魂记》《聊斋志异》；仅建议先讨论《镜花缘》。这不是主 IP 定稿，也未授权角色资产、配音、制作或发布。入制作前仍需核验指定古籍扫描卷册并排除现代校注、插图及后世视听表达。
...
```text
NEXT: P17-03 公版原作与热门题材匹配、形成主 IP 建议
```

任务：

> 用户暂停 V2 后续任务并确定小说改编方向。P17-01 已验证故事改编到静音粗剪的工作流，P17-02 已把三平台小说榜单接入 P16；下一步在保留权利门的前提下，把热门题材信号与公版原作匹配，再形成主 IP 人工决策短名单。
