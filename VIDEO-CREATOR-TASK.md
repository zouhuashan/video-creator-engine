...
```text
NEXT: P17-02 小说候选库接入自动选题池
```

任务：

> 用户暂停 V2 后续任务并确定小说改编方向。P17-01 已验证故事改编到静音粗剪的工作流；下一步把有来源的热门小说候选记录接入 P16 自动选题池，再根据候选数据和权利复核结果决定主 IP。
